...
static void deleteMidOfLList(struct node **head)
{
	...
	if (*head == NULL)
	{
		printf("\nNothing to delete, the linked list is empty\n");
	}
	else
	{
		slowPtr = *head;
...
int main()
{
	...
	while (1)
	{
		...
		printf("\nPress 11 to delete the middle of a linked list\n");
