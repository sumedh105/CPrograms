...
static void insertInTheMiddle(struct node **head, int data)
{
	struct node *temp = NULL;
	struct node *slowPtr = NULL;
	struct node *fastPtr = NULL;
	struct node *posp = NULL;

	if (*head == NULL)
	{
		printf("\nThe list is empty, nothing can be inserted\n");
	}
...
int main()
{
	...
	while (1)
	{
		...
		printf("\nPress 3 to insert a node in the middle of a linked list\n");
		printf("\nPress 4 to delete an element from the beginning of the linked list\n");
		printf("\nPress 5 to delete an element from the end of the linked list\n");
		printf("\nPress 6 to delete an element from a given position\n");
		printf("\nPress 7 to find the length of a linked list\n");
		printf("\nPress 8 to search an element in a linked list\n");
		printf("\nPress 9 to get an nth node from the beginning in a linked list\n");
		printf("\nPress 10 to get an nth node from the end in a linked list\n");
		printf("\nPress 11 to display the count of the number of times a given integer occurs in a linked list\n");
