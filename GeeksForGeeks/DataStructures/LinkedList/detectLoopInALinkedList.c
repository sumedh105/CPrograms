...
static int checkLoopInALinkedList(struct node **head)
{
...
int main()
{
	...
	while (1)
	{
		...
		printf("\nPress 11 to check whether there exists a loop in a linked list\n");
		...
		switch(choice)
		{
			...
			case 11:
			{
				...
				result = checkLoopInALinkedList(&head);

				if (result == 1)
				{
					printf("\nThere exists a loop in a linked list\n");
				}
				else
				{
					printf("\nThere is no loop in a linked list\n");
				}
