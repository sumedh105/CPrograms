...
static void removeDuplicatesFromUnsortedList(struct node **head)
{
	...
	if (*head == NULL)
	{
		printf("\nThe list is empty, cannot remove anything from the list.\n");
	}
...
int main()
{
	...
	while (1)
	{
		...
		printf("\nPress 11 to remove the duplicates from an unsorted linked list\n");
