...
static void moveLastEleToFront(struct node **head)
{
	...
	if (*head == NULL)
	{
		printf("\nThe linked list is empty, nothing can be moved\n");
	}
...
int main()
{
	...
	while (1)
	{
		...
		printf("\nPress 11 to moveLastElement to the front of a linked list\n");
