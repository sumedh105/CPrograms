...
void intToAscii(int, char [], int, int);
...
int main()
{
	...
	scanf("%d", &fieldWidth);
	printf("\nThe field width entered is: %d\n", fieldWidth);

	intToAscii(num, str, base, fieldWidth);
...
void intToAscii(int num, char str[], int base, int fieldWidth) {
	int index = 0;
	int mod = 0;
	int indexTwo = 0;
	int length = 0;
